...
class TrainESRNN(nn.Module):
    def __init__(self, model, dataloader, run_id, configuration, ohe_headers):
        ...
        self.log = Logger("../logs/train%s%s%s" % (self.configuration['variable'], self.prod_str, self.run_id))
